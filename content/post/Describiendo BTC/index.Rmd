...
kable(output_btc$r_r, booktabs = TRUE, align = "c", 
      col.names = c("Cripto","Retorno Esperado","Volatilidad"), caption = "Tabla 1: Medidas Descriptivas",format = "html")

kable(caption = "Tabla 2: VaR & TVaR", output_btc$VaR, booktabs = TRUE, align = "c", 
