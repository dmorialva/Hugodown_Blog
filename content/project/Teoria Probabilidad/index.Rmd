...
Como es de esperar, no obtenemos 50 caras y 50 sellos. Si repitieramos este experimento muchas veces más, podemos tener muchas combinaciones posibles, por ejemplo P(c) = 0.2 y P(s) = 0.8
...
probability <- apply(apply(experiment, 1, table),2, prop.table)
probability <- as.data.frame(t(probability), 
                             stringsAsFactors = F)
